<p align="center">
  <img src="./banner-hr-threads-agent.gif" alt="hr-threads-agent" />
</p>
...
- Pencarian berita dan tren HR terkini via Tavily
...
- Python 3.11+
- Akun dan API Keys (lihat bagian Setup di bawah)
...
Proses ini membutuhkan beberapa hari karena perlu review dari Meta.

1. Buka developers.facebook.com
2. Klik My Apps, lalu Create App
3. Pilih Business, isi detail app
4. Di dashboard app, klik Add Product, pilih Threads API
5. Di menu Threads API, buka User Token Generator
...
2. Klik New Project, lalu Deploy from GitHub repo
3. Pilih repository ini
4. Di Variables, tambahkan semua isi .env kamu
5. Di Settings, pada Start Command: `python main.py`
6. Deploy!
...
1. Klien membuat semua akun dan API keys (lihat panduan di atas)
...
| Tavily: API key invalid | Cek TAVILY_API_KEY di tavily.com |
